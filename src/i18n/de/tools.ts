...
export const tools: ToolsDict = {
  health: {
    ...
    areas: {
      ...
      items: ['Ihre Woche', 'Ihre Führungskräfte', 'Wie Gehalt entsteht', 'Recruiting und Onboarding', 'Verträge und Richtlinien'],
    },
  },
  cost: {
    meta: {
    ...
    included: {
      title: 'Was in der Summe steckt',
      items: ['Gehalt in der erfolglosen Zeit', 'Recruiting der ersten Besetzung', 'Zeit der Führungskraft', 'Abfindung und Kündigungsfrist', 'Recruiting der Nachbesetzung', 'Die leere Stelle'],
    },
  },
};
